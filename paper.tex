...
\begin{proof}[\pfref{thm:bandit}]
  ...
  \begin{align}
    ...
    H_\alpha(\pi) = (1-\alpha)^{-1}H((1-\alpha)\pi+\alpha\piref),
  \end{align}
  ...
  \begin{lemma}
    ...
    \begin{lemma}
      ...
      \begin{align*}
        \beta^{-1}\tri*{\grad{}H_\alpha(\pi\ind{t}),\pi\ind{t+1}-\pistar}
        \leq{} \Dkl{\pistar}{\pi\ind{t}}
  - \Dkl{\pistar}{\pi\ind{t+1}}
  - \Dkl{\pi\ind{t+1}}{\pi\ind{t}} + \beta^{-1}\veps.
      \end{align*}
    \end{lemma}
    Let $\pibar\ind{t}\ldef{}(1-\alpha)\pi\ind{t}+\alpha\piref$. Let
    ...
    \begin{align}
      ...
      \pibar\ind{t}(\ystar)\geq{}(\pibar\ind{t}(y))^{\gamma}\quad\forall{}y\neq\ystar,
        ...
        \begin{align*}
          \log\prn*{
          \frac{\pi\ind{t}(\ystar)}{\pi\ind{t+1}(\ystar)}
          }
          &= \Dkl{\pistar}{\pi\ind{t+1}}-\Dkl{\pistar}{\pi\ind{t}}\\
            &\leq{}
          -\beta^{-1}\tri*{\grad{}H_\alpha(\pi\ind{t}),\pi\ind{t+1}-\pistar}
              - \Dkl{\pistar}{\pi\ind{t+1}} + \beta^{-1}\veps\\
          &=
            -\beta^{-1}\tri*{\grad{}H_\alpha(\pi\ind{t}),\pi\ind{t}-\pistar}
            + \beta^{-1}\tri*{\grad{}H_\alpha(\pi\ind{t}),\pi\ind{t}-\pi\ind{t+1}}
          - \Dkl{\pistar}{\pi\ind{t+1}} + \beta^{-1}\veps.
        \end{align*}
        ...
        \begin{lemma}[Gradient dominance]
          ...
          \begin{align*}
            \tri*{\grad{}H_\alpha(\pi\ind{t}),\pi\ind{t}-e_{\ystar}}
            \geq{}
