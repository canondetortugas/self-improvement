...
\begin{comment}
  Here we focus on the bandit special case where $\cX=\emptyset$ and
  $\Pi=\Delta(\cY)$. In this case, the population version of
  \cref{eq:self_training} is given by
  \[
    \pi\ind{t+1}=\argmin\crl*{\Dkl{\pi\ind{t}}{\pi} +
      \beta\Dkl{\pi}{\pi\ind{t}}}.
  \]
\end{comment}
